...
void Shader::init(const char *vsFile, const char *fsFile) {
	...
	glLinkProgram(this->shader_id); // Link the vertex and fragment shaders in the program
    validateProgram(this->shader_id); // Validate the shader program
}

void Shader::BindAtributs(const char *name)
{
	unsigned int location = glGetAttribLocation(this->shader_id,name);
	glBindAttribLocation(this->shader_id, location, name);
}
